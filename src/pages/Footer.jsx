...
function Footer() {
  return (
    <section className="rounded-rt-2xl mt-10 flex w-full justify-between rounded-tl-2xl rounded-tr-2xl bg-white px-6 py-12 font-inter dark:bg-darkMode-background dark:text-darkMode-textGray lg:px-16">
      <div>
        <h1 className="mb-2 font-semibold dark:text-darkMode-textGray">
          Follow me on
        </h1>
