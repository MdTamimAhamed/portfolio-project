...
function About() {
  return (
    <main
      id="about"
      className="  relative mt-12 grid gap-3 rounded-2xl md:grid-cols-3 lg:grid-cols-4"
    >
      ...
      <article className=" rounded-2xl bg-white px-6 py-20 dark:bg-darkMode-background md:col-span-2 md:row-span-2  lg:col-span-3 lg:px-16 ">
        <h3 className="text-3xl font-bold leading-4 tracking-tight dark:text-darkMode-textGray sm:leading-none">
        ...
        <div className="mt-14 flex items-center justify-between  gap-4 md:justify-start">
          <CTABtn cta_name="Resume" border={false} icon_visivility={false} />
          <CTABtn
            cta_name="Projects"
            link="#projects"
            border={true}
      ...
      <figure className="flex items-center justify-center rounded-2xl bg-white py-4 dark:bg-darkMode-background">
        <img
      ...
      <div className=" flex flex-col items-center justify-center rounded-2xl bg-white p-6 dark:bg-darkMode-background">
        ...
        <div className="flex items-center justify-center gap-6 text-3xl dark:text-darkMode-textGray md:gap-4 md:text-[26px]">
          <a
